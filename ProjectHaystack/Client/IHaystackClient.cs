...
namespace ProjectHaystack.Client
{
    ...
    public interface IHaystackClient
    {
        ...
        /// <param name="mimeResponse">MIME type requested for the response.</param>
        /// <returns>Raw HTTP content.</returns>
        Task<string> GetStringAsync(string op, Dictionary<string, string> @params, CancellationToken cancellationToken, string mimeResponse = "text/zinc");
        ...
        /// <param name="mimeResponse">MIME type requested for the response.</param>
        /// <returns>Raw HTTP content.</returns>
        Task<string> PostStringAsync(string op, string req, CancellationToken cancellationToken, string mimeRequest = "text/zinc", string mimeResponse = "text/zinc");
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Action result grid.</returns>
        Task<HaystackGrid> InvokeActionAsync(HaystackReference id, string action, HaystackDictionary args, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid with records.</returns>
        Task<HaystackGrid> ReadAllAsync(string filter, int limit, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Matching record.</returns>
        Task<HaystackDictionary> ReadAsync(string filter, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid with records.</returns>
        Task<HaystackGrid> ReadByIdsAsync(HaystackReference[] ids, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Matching record.</returns>
        Task<HaystackDictionary> ReadByIdAsync(HaystackReference id, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid of results.</returns>
        Task<HaystackGrid> EvalAsync(string expr, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid of results per expression.</returns>
        Task<HaystackGrid[]> EvalAllAsync(HaystackGrid req, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid of results per expression.</returns>
        Task<HaystackGrid[]> EvalAllAsync(string[] exprs, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid of time-series data.</returns>
        Task<HaystackGrid> HisReadAsync(HaystackReference id, HaystackDateTimeRange range, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid of time-series data.</returns>
        Task<HaystackGrid> HisReadAsync(HaystackReference id, string range, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <param name="metaData">Optional metadata to include.</param>
        Task<HaystackGrid> HisWriteAsync(HaystackReference id, HaystackHistoryItem[] items, CancellationToken cancellationToken, HaystackDictionary metaData = null);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Result grid.</returns>
        Task<HaystackGrid> PointWriteAsync(HaystackReference id, int level, string who, HaystackValue val, HaystackNumber dur, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Result grid.</returns>
        Task<HaystackGrid> PointWriteArrayAsync(HaystackReference id, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Grid of results.</returns>
        Task<HaystackGrid> CallAsync(string op, HaystackGrid req, CancellationToken cancellationToken);
