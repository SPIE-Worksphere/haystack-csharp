...
namespace ProjectHaystack.Client
{
    ...
    /// <summary>
    /// HttpAsyncClient asynchronously manages a logical connection to a HTTP REST haystack server using HttpClient.
    /// </summary>
    /// <seealso cref="http://project-haystack.org/doc/Rest">Project Haystack</seealso>
    public class HttpAsyncClient : IHClient, IHProj, IHAsyncClient
    {
        ...
        /// </summary>
        public HttpAsyncClient(IAuthenticator authentication, Uri apiUri)
        ...
        public async Task<string> GetStringAsync(string op, Dictionary<string, string> @params, string mimeRequest = "text/zinc", string mimeResponse = "text/zinc")
        {
