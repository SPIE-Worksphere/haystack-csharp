...
//        public void testStr()
//        {
//            verifyParse("x==\"hi\"", HFilter.eq("x", new HaystackString("hi")));
//            verifyParse("x!=\"\\\"hi\\\"\"", HFilter.ne("x", new HaystackString("\"hi\"")));
//            verifyParse("x==\"_\\u00a3_\\n_\"", HFilter.eq("x", new HaystackString("_\u00a3_\n_"))); // Was abcd but changed to valid unicode pound
//        }
//
//        [TestMethod]
//        public void testUri()
...
//        public void testInt()
//        {
//            verifyParse("num < 4", HFilter.lt("num", new HaystackNumber(4)));
//            verifyParse("num <= -99", HFilter.le("num", new HaystackNumber(-99)));
//        }
//
//        [TestMethod]
//        public void testFloat()
//        {
//            verifyParse("num < 4.0", HFilter.lt("num", new HaystackNumber(4f)));
//            verifyParse("num <= -9.6", HFilter.le("num", new HaystackNumber(-9.6f)));
//            verifyParse("num > 400000", HFilter.gt("num", new HaystackNumber(4e5f)));
//            verifyParse("num >= 16000", HFilter.ge("num", new HaystackNumber(1.6e+4f)));
//            verifyParse("num >= 2.16", HFilter.ge("num", new HaystackNumber(2.16)));
//        }
//
//        [TestMethod]
//        public void testUnit()
//        {
//            verifyParse("dur < 5ns", HFilter.lt("dur", new HaystackNumber(5, "ns")));
//            verifyParse("dur < 10kg", HFilter.lt("dur", new HaystackNumber(10, "kg")));
//            verifyParse("dur < -9sec", HFilter.lt("dur", new HaystackNumber(-9, "sec")));
//            verifyParse("dur < 2.5hr", HFilter.lt("dur", new HaystackNumber(2.5, "hr")));
//        }
//
//        [TestMethod]
...
//            verifyParse("a and b and c == 3", HFilter.has("a").and(HFilter.has("b").and(HFilter.eq("c", new HaystackNumber(3)))));
//        }
//
//        [TestMethod]
//        public void testOr()
...
//            verifyParse("a or b or c == 3", HFilter.has("a").or(HFilter.has("b").or(HFilter.eq("c", new HaystackNumber(3)))));
//        }
//
//        [TestMethod]
